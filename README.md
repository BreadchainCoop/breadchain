...
2. run `forge clean && forge build && forge script script/upgrades/UpgradeYieldDistributor.s.sol --sig "run(address)" --args <proxy_address> --rpc-url $RPC_URL  --sender <proxy_admin>` 
