...
contract YieldDistributor is IYieldDistributor, Ownable2StepUpgradeable, VotingMultipliers, GasKillerSDK {
    ...
    function initialize(
        ...
        // Initialize via __VotingMultipliers_init, which internally calls __Ownable_init.
        // This produces a linear init chain: __VotingMultipliers_init → __Ownable_init.
     ...
     * @dev In the standard deployment flow, Ownable is initialized by __VotingMultipliers_init
     *      which is called by initialize(). This function is kept for interface compatibility
     *      but is a no-op. Safe to call after initialize() since Ownable is already set.
     * @custom:oz-upgrades-unsafe-allow missing-initializer-call
     */
    function initializeVotingMultipliers(address) public reinitializer(1) {
        // No-op: all initialization is handled by initialize()
    }
